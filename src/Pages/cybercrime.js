...
const cybercrime = () => {
    return (
        ...
        <img class="" src={image} style={{ width : "100%"}}></img></div>
        <div class="container">
            ...
            <hr></hr>
                ...
                <h2 class="title">
                  <span style={{ color: "#A4303F"}}>The need of cyber security </span></h2> <hr />
                  <p 
                style={{
                    fontsize: "30px",
                    textAlign:"justify",
                    padding:"5px",
                    fontWeight:"bold"
                }}> ⇒ Cyber Security protects the cyberspace from the following :</p>
                <p
                style={{
                    fontsize: "30px",
                    textAlign:"justify",
                    padding:"10px"
                }}> <b>1) Cyber Attacks : </b>  A cyber attack is a set of actions performed by threat actors, who try to gain unauthorized access, steal data or cause damage to computers, computer networks, or other computing systems.The individuals who launch cyber attacks are usually referred to as cybercriminals, threat actors, bad actors, or hackers.</p>
                <p
                style={{
                    fontsize: "30px",
                    textAlign:"justify",
                ...
                }}> <b>2)Damage to Cyberspace : </b> Damage to cyberspace can encompass a range of issues, including cyber threats, attacks, and vulnerabilities.Addressing damage to cyberspace requires a multifaceted approach involving cybersecurity measures, international cooperation, legislative frameworks.</p>
                 <p
                style={{
                    fontsize: "30px",
                    textAlign:"justify",
                ...
                }}> <b>3) Misuse of Cyberspace : </b> The misuse of cyberspace refers to various activities that exploit digital platforms and networks for malicious or harmful purposes. As technology advances, so do the methods employed by individuals or groups engaging in cyber misconduct.</p>
                 <p
                style={{
                    fontsize: "30px",
                    textAlign:"justify",
                ...
                }}><b>4) Economic Espionage : </b> Economic espionage refers to the act of stealing trade secrets, proprietary information, intellectual property (IP), or confidential business strategies from companies, governments, or institutions to use it to gain a competitive advantage, often for the benefit of another company or country.</p>
                <hr ></hr>

                <h2 class="title">
                  <span style={{ color: "#A4303F"}}>Cyber Security - Evolution </span></h2> <hr />
                  <p
                style={{
                    fontsize: "30px",
                    textAlign:"justify",
                  ...
                  <b>With the introduction of cyberattacks, cybersecurity initiatives have evolved. They are mentioned in the table below:</b>
                  </p>
                  ...
                  <table class="table table-bordered" style={{border:"1px solid black"}}>
                    <tbody>
                    <tr>
                    <th style={{textAlign:"center" , backgroundColor:"purple",color:"white"}}>
                    Evolution of Cyber Security
                    </th>
                    </tr>
                  
                    <tr>
                    <td style={{textAlign: "center" }} ><strong>Issues</strong></td>
                    <td style={{textAlign: "center" }}><strong>Cyber Security Initiatives</strong></td>
                    </tr>
